...
// SKBB#0:                                 // %entry
	...
	v_or_b32 v2, 16, v1
	v_add_i32 v2, vcc, s13, v2
	tbuffer_load_format_xyzw v[2:5], v2, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32_32_32_32,BUF_NUM_FORMAT_FLOAT]
	v_add_i32 v1, vcc, s13, v1
	tbuffer_load_format_xyzw v[6:9], v1, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32_32_32_32,BUF_NUM_FORMAT_FLOAT]
	v_lshlrev_b32 v1, 4, v0
	s_lshr_b32 s4, s2, 1
	v_add_i32 v1, vcc, s1, v1
	s_mov_b32 m0, -1
...
// SKBB#4:                                 // %if.then
	...
	ds_write_b32 v5, v6
	v_add_i32 v5, vcc, v9, v13
	ds_write_b32 v3, v5
	v_add_i32 v3, vcc, v8, v12
	s_waitcnt lgkmcnt(0)
	v_add_i32 v5, vcc, v7, v11
	ds_write_b32 v4, v3
	ds_write_b32 v1, v5
	s_waitcnt lgkmcnt(0)
SKBB0_5:                                  // %if.end
...
// SKBB#6:                                 // %if.then.14
	...
	ds_read_b32 v6, v3
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_xyzw v[5:8], v4, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32_32_32_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0) & expcnt(0)
SKBB0_7:                                  // %if.end.17
	s_or_b64 exec, exec, s[2:3]
	s_endpgm
...
// Merged Reduction_Kernels_burr.s Reduction_Kernels_mihybrid.s
