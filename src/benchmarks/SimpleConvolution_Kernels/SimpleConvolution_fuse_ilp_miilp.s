...
// BB#0:                                 // %entry
	...
	v_cmp_le_u32 s[0:1], s16, v1
	v_subrev_i32 v3, vcc, s16, v1
	...
	s_lshr_b32 s10, s0, 1
	v_mov_b32 v1, s1
	v_add_i32 v2, vcc, s10, v4
	v_cmp_gt_u32 vcc, s16, v2
	v_cndmask_b32 v1, v1, v2, vcc
	v_subrev_i32 v2, vcc, s10, v4
	v_cmp_gt_u32 vcc, s10, v4
...
// BB#1:                                 // %for.cond.27.preheader.lr.ph
	...
	v_sub_i32 v4, vcc, s10, v4
	v_mov_b32 v3, 0
	s_lshr_b32 s11, s0, 1
	v_subrev_i32 v7, vcc, v6, v0
	v_cmp_ge_u32 vcc, v0, v6
	...
	v_cmp_gt_u32 s[0:1], s11, v6
	v_add_i32 v5, vcc, s11, v6
	v_cmp_gt_u32 vcc, s17, v5
	v_cndmask_b32 v5, v7, v5, vcc
	v_subrev_i32 v7, vcc, s11, v6
	v_sub_i32 v6, vcc, s11, v6
...
// SKBB#0:                                 // %entry
	...
	v_add_i32 v1, vcc, s16, v1
	v_cndmask_b32 v6, v2, v1, s[0:1]
	v_cmp_gt_u32 s[0:1], s6, v6
	v_add_i32 v2, vcc, s6, v6
	v_subrev_i32 v1, vcc, s6, v6
...
// SKBB#1:                                 // %for.cond.27.preheader.lr.ph
	...
	v_cndmask_b32 v5, v7, v5, s[2:3]
	v_sub_i32 v6, vcc, s6, v6
	v_sub_i32 v7, vcc, s7, v3
	s_mov_b64 s[0:1], 0
	v_mov_b32 v3, 0
...
// Merged SimpleConvolution_Kernels_ilp.s SimpleConvolution_Kernels_miilp.s
