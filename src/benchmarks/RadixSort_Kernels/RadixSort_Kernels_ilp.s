...
// BB#0:                                 // %entry
	...
	s_buffer_load_dword s1, s[8:11], 0x4
	s_buffer_load_dword s7, s[8:11], 0x8
...
BB1_2:                                  // %for.body
	...
	tbuffer_load_format_x v12, v12, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v13, v13, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v14, v14, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v15, v15, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v16, v16, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v17, v17, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v18, v18, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v19, v19, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v20, v20, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
BB1_4:                                  // %for.body.15
	...
	tbuffer_load_format_x v4, v4, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0)
	v_bfe_u32 v5, v4, s2, 8
	v_or_b32 v5, v5, v1
	v_lshlrev_b32 v5, 1, v5
	v_add_i32 v5, vcc, s4, v5
	ds_read_u16 v6, v5
	s_waitcnt lgkmcnt(0)
	v_lshlrev_b32 v7, 2, v6
	v_add_i32 v6, vcc, 1, v6
	ds_write_b16 v5, v6
	v_add_i32 v5, vcc, s5, v7
	tbuffer_store_format_x v4, v5, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// BB#3:                                 // %for.cond.cleanup
	...
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v3, v2, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_mov_b32 v2, 0
...
// BB#0:                                 // %entry
	...
	s_load_dwordx4 s[16:19], s[2:3], 0x58
	s_load_dwordx4 s[20:23], s[2:3], 0x50
	v_add_i32 v2, vcc, s7, v1
	v_mul_lo_i32 v3, v2, s6
	s_min_u32 s0, s0, s15
	s_mul_i32 s2, s0, s12
	v_add_i32 v4, vcc, s2, v0
	v_add_i32 v3, vcc, v3, v4
	v_lshlrev_b32 v5, 2, v3
	v_add_i32 v6, vcc, s14, v5
	v_mov_b32 v5, 0
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v5, v6, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0) & expcnt(0)
	v_mov_b32 v5, 0
...
// BB#0:                                 // %entry
	...
	s_buffer_load_dword s6, s[8:11], 0x8
	s_mov_b32 s7, 0xffff
