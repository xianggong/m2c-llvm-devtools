...
// BB#0:                                 // %entry
	...
	s_buffer_load_dword s7, s[8:11], 0xc
	...
	v_mul_lo_i32 v4, v3, s7
	v_cmp_ge_u32 vcc, s14, v4
	v_cndmask_b32 v5, 0, -1, vcc
	v_sub_i32 v4, vcc, s14, v4
	v_cmp_le_u32 vcc, s7, v4
...
// BB#6:                                 // %if.then
	...
	s_mov_b32 m0, -1
	ds_read_b32 v4, v2
	v_subrev_i32 v5, vcc, v3, v0
	v_lshlrev_b32 v5, 2, v5
	v_add_i32 v5, vcc, s1, v5
	ds_read_b32 v5, v5
	s_waitcnt lgkmcnt(0)
	v_add_i32 v4, vcc, v5, v4
BB3_7:                                  // %if.end
                                        //   in Loop: Header=BB3_5 Depth=1
