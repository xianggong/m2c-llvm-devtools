...
BB1_2:                                  // %for.body
	...
	s_waitcnt vmcnt(14)
	ds_write_b16 v6, v7
	v_add_i32 v6, vcc, 4, v3
	s_waitcnt vmcnt(13)
	ds_write_b16 v6, v8
	v_add_i32 v6, vcc, 6, v3
	s_waitcnt vmcnt(12)
	ds_write_b16 v6, v9
	v_add_i32 v6, vcc, 8, v3
	s_waitcnt vmcnt(11)
	ds_write_b16 v6, v10
	v_add_i32 v6, vcc, 10, v3
	s_waitcnt vmcnt(10)
	ds_write_b16 v6, v11
	v_add_i32 v6, vcc, 12, v3
	s_waitcnt vmcnt(9)
	ds_write_b16 v6, v12
	v_add_i32 v6, vcc, 14, v3
	s_waitcnt vmcnt(8)
	ds_write_b16 v6, v13
	v_add_i32 v6, vcc, 16, v3
	s_waitcnt vmcnt(7)
	ds_write_b16 v6, v14
	v_add_i32 v6, vcc, 18, v3
	s_waitcnt vmcnt(6)
	ds_write_b16 v6, v15
	v_add_i32 v6, vcc, 20, v3
	s_waitcnt vmcnt(5)
	ds_write_b16 v6, v16
	v_add_i32 v6, vcc, 22, v3
	s_waitcnt vmcnt(4)
	ds_write_b16 v6, v17
	v_add_i32 v6, vcc, 24, v3
	s_waitcnt vmcnt(3)
	ds_write_b16 v6, v18
	v_add_i32 v6, vcc, 26, v3
	s_waitcnt vmcnt(2)
	ds_write_b16 v6, v19
	v_add_i32 v6, vcc, 28, v3
	s_waitcnt vmcnt(1)
	ds_write_b16 v6, v20
	v_add_i32 v6, vcc, 30, v3
	s_waitcnt vmcnt(0)
	ds_write_b16 v6, v5
...
// BB#0:                                 // %entry
	...
	s_buffer_load_dword s16, s[8:11], 0x14
	...
	v_mul_lo_i32 v4, v3, s17
	v_sub_i32 v5, vcc, s2, v4
	v_cmp_le_u32 vcc, s17, v5
