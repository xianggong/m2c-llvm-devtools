...
// BB#0:                                 // %entry
	...
	v_sub_i32 v2, vcc, s5, v1
	v_cvt_f32_u32 v3, v2
	v_rcp_f32 v3, v3
	v_mul_f32 v3, 0x4f800000, v3
	v_cvt_u32_f32 v3, v3
	v_mul_lo_i32 v4, v3, v2
	...
	v_mul_lo_i32 v4, v3, v2
	v_cmp_ge_u32 s[0:1], s12, v4
	v_sub_i32 v4, vcc, s12, v4
	v_cmp_ge_u32 vcc, v4, v2
	v_cndmask_b32 v2, 0, -1, s[0:1]
	v_cmp_eq_i32 s[0:1], 0, v2
	v_cndmask_b32 v4, 0, -1, vcc
	v_and_b32 v2, v2, v4
	v_cmp_eq_i32 s[2:3], 0, v2
	v_cvt_f32_u32 v2, s14
	v_rcp_f32 v2, v2
	...
	v_cmp_ge_u32 s[2:3], v1, v2
	v_subrev_i32 v1, vcc, v2, v1
	v_cmp_le_u32 vcc, s14, v1
	v_cndmask_b32 v2, 0, -1, s[2:3]
	v_cmp_eq_i32 s[2:3], 0, v2
	v_cndmask_b32 v3, 0, -1, vcc
	v_and_b32 v2, v2, v3
