...
// BB#10:                                // %if.then.35
                                        //   in Loop: Header=BB0_7 Depth=1
	v_subrev_f32 v8, v6, v7
	v_mul_lo_i32 v9, v5, s12
	v_mov_b32 v10, 0x3f3504f3
	...
	s_mov_b32 m0, -1
	ds_write_b32 v1, v10
	tbuffer_store_format_x v8, v9, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// SKBB#0:                                 // %entry
	s_buffer_load_dword s17, s[4:7], 0x4
	...
	s_waitcnt lgkmcnt(0)
	tbuffer_load_format_x v4, v3, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v3, v1, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// SKBB#10:                                // %if.then.35
	...
	tbuffer_store_format_x v9, v8, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// Merged DwtHaar1D_Kernels_fast.s DwtHaar1D_Kernels_ilp.s
