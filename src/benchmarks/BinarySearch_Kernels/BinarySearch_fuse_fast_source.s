...
// Merged BinarySearch_Kernels_fast.s BinarySearch_Kernels_source.s
...
// BB#1:                                 // %for.body.lr.ph
	...
	v_add_i32 v1, vcc, s1, v2
	v_or_b32 v2, 0x3fc, v2
...
// BB#0:                                 // %entry
	...
	v_cvt_u32_f32 v1, v1
	v_mul_lo_i32 v2, v1, s26
	v_mul_hi_u32 v3, v1, s26
...
// SKBB#0:                                 // %entry
	s_buffer_load_dword s28, s[8:11], 0x0
	s_buffer_load_dword s13, s[8:11], 0x4
	s_buffer_load_dword s29, s[8:11], 0x8
	s_buffer_load_dword s30, s[8:11], 0xc
	s_buffer_load_dword s8, s[8:11], 0x10
	s_mov_b64 s[10:11], 0
	s_mov_b64 s[14:15], 0
	s_load_dwordx4 s[16:19], s[2:3], 0x60
	...
	v_cndmask_b32 v0, v3, v1, s[2:3]
	v_lshlrev_b32 v1, 2, v0
	v_add_i32 v1, vcc, s28, v1
	tbuffer_load_format_x v1, v1, s[24:27], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_mul_hi_u32 v2, v2, s29
	v_subrev_i32 v3, vcc, s30, v4
	v_mul_lo_i32 v5, v2, s30
	v_cndmask_b32 v3, v3, v4, s[0:1]
	v_add_i32 v4, vcc, s30, v4
	v_cndmask_b32 v3, v3, v4, s[2:3]
	v_cmp_ge_u32 vcc, s29, v5
	v_cndmask_b32 v4, 0, -1, vcc
	v_sub_i32 v5, vcc, s29, v5
	v_cmp_le_u32 vcc, s30, v5
	v_cndmask_b32 v5, 0, -1, vcc
	v_and_b32 v5, v4, v5
...
SKBB2_2:                                  // %while.body
	...
	v_lshlrev_b32 v5, 2, v2
	v_add_i32 v5, vcc, s13, v5
	tbuffer_load_format_x v8, v5, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_mov_b32 v7, 0
	s_waitcnt vmcnt(0)
	v_cmp_ne_i32 vcc, v8, v1
	v_mov_b32 v6, -1
