...
// SKBB#2:                                 // %for.body.lr.ph
	...
	v_mul_lo_i32 v23, v8, s3
	v_mul_lo_i32 v24, v1, s3
	v_mov_b32 v25, v2
	v_mov_b32 v17, v2
	v_mov_b32 v18, v3
	v_mov_b32 v19, v4
...
SKBB0_6:                                  // %for.body
	...
	v_add_f32 v12, v46, v12
	v_mac_f32 v28, v55, v30
	v_mac_f32 v45, v57, v30
	v_mac_f32 v44, v56, v30
	v_add_f32 v11, v45, v11
	v_add_f32 v10, v44, v10
	v_add_f32 v9, v28, v9
	s_or_b64 s[20:21], vcc, s[20:21]
	s_andn2_b64 exec, exec, s[20:21]
...
// Merged MatrixMultiplication_Kernels_burr.s MatrixMultiplication_Kernels_mihybrid.s
...
BB1_8:                                  // %for.body.51
	...
	ds_read_b32 v53, v50
	ds_read_b32 v56, v51
	v_add_i32 v51, vcc, v47, v24
	v_lshlrev_b32 v51, 4, v51
	v_add_i32 v51, vcc, s1, v51
	v_add_i32 v54, vcc, 12, v51
	ds_read_b32 v57, v51
	ds_read_b32 v60, v54
	v_add_i32 v47, vcc, v47, v23
	v_lshlrev_b32 v47, 4, v47
	v_add_i32 v47, vcc, s1, v47
	v_add_i32 v54, vcc, 12, v47
	ds_read_b32 v61, v47
	ds_read_b32 v64, v54
	v_add_i32 v54, vcc, 8, v47
	ds_read_b32 v63, v54
	v_add_i32 v47, vcc, 4, v47
	ds_read_b32 v62, v47
	v_add_i32 v47, vcc, 8, v51
	ds_read_b32 v59, v47
	v_add_i32 v47, vcc, 4, v51
	ds_read_b32 v58, v47
	v_add_i32 v47, vcc, 8, v50
	ds_read_b32 v55, v47
	v_add_i32 v47, vcc, 4, v50
	ds_read_b32 v54, v47
	v_add_i32 v47, vcc, 8, v48
	ds_read_b32 v51, v47
	v_add_i32 v47, vcc, 4, v48
	ds_read_b32 v50, v47
	s_waitcnt vmcnt(3) & lgkmcnt(0)
	v_mul_f32 v47, v38, v62
	v_mul_f32 v48, v37, v62
	v_mul_f32 v65, v36, v62
	v_mul_f32 v62, v35, v62
	v_mul_f32 v66, v38, v58
	v_mul_f32 v67, v37, v58
	v_mul_f32 v68, v36, v58
	v_mul_f32 v58, v35, v58
	v_mul_f32 v69, v38, v54
	v_mul_f32 v70, v37, v54
	v_mul_f32 v71, v36, v54
	v_mul_f32 v54, v35, v54
	v_mul_f32 v38, v38, v50
	v_mul_f32 v37, v37, v50
	v_mul_f32 v36, v36, v50
	v_mul_f32 v35, v35, v50
	s_waitcnt vmcnt(2)
	v_mac_f32 v47, v42, v61
	v_mac_f32 v48, v41, v61
	v_mac_f32 v65, v40, v61
	v_mac_f32 v62, v39, v61
	v_mac_f32 v66, v42, v57
	v_mac_f32 v67, v41, v57
	v_mac_f32 v68, v40, v57
	v_mac_f32 v58, v39, v57
	v_mac_f32 v69, v42, v53
	v_mac_f32 v70, v41, v53
	v_mac_f32 v71, v40, v53
	v_mac_f32 v54, v39, v53
	v_mac_f32 v38, v42, v49
	v_mac_f32 v37, v41, v49
	v_mac_f32 v36, v40, v49
	v_mac_f32 v35, v39, v49
	s_waitcnt vmcnt(1)
	v_mac_f32 v47, v46, v63
	v_mac_f32 v48, v45, v63
	v_mac_f32 v65, v44, v63
	v_mac_f32 v62, v43, v63
	v_mac_f32 v66, v46, v59
	v_mac_f32 v67, v45, v59
	v_mac_f32 v68, v44, v59
	v_mac_f32 v58, v43, v59
	v_mac_f32 v69, v46, v55
	v_mac_f32 v70, v45, v55
	v_mac_f32 v71, v44, v55
	v_mac_f32 v54, v43, v55
	v_mac_f32 v38, v46, v51
	v_mac_f32 v37, v45, v51
	v_mac_f32 v36, v44, v51
	v_mac_f32 v35, v43, v51
	s_waitcnt vmcnt(0)
	v_mac_f32 v47, v34, v64
	v_mac_f32 v48, v33, v64
	v_mac_f32 v65, v32, v64
	v_mac_f32 v62, v31, v64
	v_mac_f32 v66, v34, v60
	v_mac_f32 v67, v33, v60
	v_mac_f32 v68, v32, v60
	v_mac_f32 v58, v31, v60
	v_mac_f32 v69, v34, v56
	v_mac_f32 v70, v33, v56
	v_mac_f32 v71, v32, v56
	v_mac_f32 v54, v31, v56
	v_mac_f32 v38, v34, v52
	v_mac_f32 v37, v33, v52
	v_mac_f32 v36, v32, v52
	v_mac_f32 v35, v31, v52
	v_add_f32 v8, v47, v8
	...
	v_add_f32 v17, v54, v17
	v_add_f32 v9, v35, v9
	v_add_i32 v29, vcc, 4, v29
	v_cmp_le_u32 vcc, s7, v29
...
SKBB1_8:                                  // %for.body.51
	...
	v_add_i32 v32, vcc, v31, v24
	v_add_i32 v33, vcc, v31, v25
	v_add_i32 v34, vcc, v31, v1
	v_add_i32 v31, vcc, v31, v23
	v_lshlrev_b32 v32, 4, v32
	v_lshlrev_b32 v33, 4, v33
	...
	v_mul_f32 v42, v39, v44
	v_mul_f32 v67, v38, v44
	v_mul_f32 v68, v37, v44
	v_mul_f32 v44, v36, v44
	v_mul_f32 v69, v39, v48
	v_mul_f32 v70, v38, v48
	v_mul_f32 v71, v37, v48
	v_mul_f32 v48, v36, v48
	v_mul_f32 v39, v39, v52
	v_mul_f32 v38, v38, v52
	v_mul_f32 v37, v37, v52
	v_mul_f32 v36, v36, v52
	s_waitcnt vmcnt(2)
	v_mac_f32 v31, v58, v32
	v_mac_f32 v40, v57, v32
	v_mac_f32 v41, v56, v32
	v_mac_f32 v33, v55, v32
	v_mac_f32 v42, v58, v43
	v_mac_f32 v67, v57, v43
	v_mac_f32 v68, v56, v43
	v_mac_f32 v44, v55, v43
	v_mac_f32 v69, v58, v47
	v_mac_f32 v70, v57, v47
	v_mac_f32 v71, v56, v47
	v_mac_f32 v48, v55, v47
	v_mac_f32 v39, v58, v51
	v_mac_f32 v38, v57, v51
	v_mac_f32 v37, v56, v51
	v_mac_f32 v36, v55, v51
	s_waitcnt vmcnt(1)
	v_mac_f32 v31, v62, v34
	v_mac_f32 v40, v61, v34
	v_mac_f32 v41, v60, v34
	v_mac_f32 v33, v59, v34
	v_mac_f32 v42, v62, v45
	v_mac_f32 v67, v61, v45
	v_mac_f32 v68, v60, v45
	v_mac_f32 v44, v59, v45
	v_mac_f32 v69, v62, v49
	v_mac_f32 v70, v61, v49
	v_mac_f32 v71, v60, v49
	v_mac_f32 v48, v59, v49
	v_mac_f32 v39, v62, v53
	v_mac_f32 v38, v61, v53
	v_mac_f32 v37, v60, v53
	v_mac_f32 v36, v59, v53
	s_waitcnt vmcnt(0)
	v_mac_f32 v31, v66, v35
	v_add_f32 v6, v31, v6
	v_mac_f32 v36, v63, v54
	v_mac_f32 v33, v63, v35
	v_mac_f32 v40, v65, v35
	v_mac_f32 v41, v64, v35
	v_mac_f32 v42, v66, v46
	v_add_f32 v16, v42, v16
	v_mac_f32 v44, v63, v46
	v_mac_f32 v67, v65, v46
	v_mac_f32 v68, v64, v46
	v_mac_f32 v69, v66, v50
	v_add_f32 v20, v69, v20
	v_mac_f32 v48, v63, v50
	v_mac_f32 v70, v65, v50
	v_mac_f32 v71, v64, v50
	v_mac_f32 v39, v66, v54
	...
	v_mac_f32 v38, v65, v54
	v_mac_f32 v37, v64, v54
