...
// BB#0:                                 // %entry
	...
	v_subrev_i32 v5, vcc, v2, v0
	v_cmp_ge_u32 vcc, v0, v2
	v_cmp_le_u32 s[0:1], s8, v5
	v_cndmask_b32 v0, 0, -1, vcc
	v_cndmask_b32 v2, 0, -1, s[0:1]
	v_cmp_eq_i32 s[0:1], 0, v0
	v_and_b32 v0, v0, v2
	v_subrev_i32 v2, vcc, s8, v5
	v_cmp_eq_i32 s[2:3], 0, v0
	v_cndmask_b32 v0, v3, v1, s[2:3]
	v_cndmask_b32 v0, v0, v4, s[0:1]
	v_mul_lo_i32 v0, s8, v0
	v_add_i32 v1, vcc, s8, v5
	v_cndmask_b32 v2, v2, v5, s[2:3]
...
// Merged FastWalshTransform_Kernels_fast.s FastWalshTransform_Kernels_ilp.s
