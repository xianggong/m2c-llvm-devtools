...
// BB#0:                                 // %entry
	...
	v_subrev_i32 v4, vcc, v2, v0
	v_cmp_ge_u32 vcc, v0, v2
	v_cndmask_b32 v0, 0, -1, vcc
	v_cmp_le_u32 vcc, s8, v4
	v_cndmask_b32 v2, 0, -1, vcc
	v_cmp_eq_i32 s[0:1], 0, v0
	v_and_b32 v0, v0, v2
	v_add_i32 v2, vcc, -1, v1
	v_cmp_eq_i32 s[2:3], 0, v0
	v_subrev_i32 v0, vcc, s8, v4
	v_cndmask_b32 v1, v3, v1, s[2:3]
	v_cndmask_b32 v1, v1, v2, s[0:1]
	v_mul_lo_i32 v1, s8, v1
	v_add_i32 v2, vcc, s8, v4
	v_cndmask_b32 v0, v0, v4, s[2:3]
	v_cndmask_b32 v0, v0, v2, s[0:1]
	...
	s_waitcnt lgkmcnt(0)
	tbuffer_load_format_x v2, v0, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_load_format_x v3, v1, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0)
	v_add_f32 v4, v3, v2
	v_subrev_f32 v2, v3, v2
	tbuffer_store_format_x v4, v0, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	tbuffer_store_format_x v2, v1, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_endpgm
...
// SKBB#0:                                 // %entry
	...
	v_cmp_le_u32 vcc, s14, v0
	v_cndmask_b32 v2, 0, -1, vcc
	v_and_b32 v2, v3, v2
	v_cmp_eq_i32 s[2:3], 0, v2
	v_subrev_i32 v2, vcc, s14, v0
	...
	v_mul_lo_i32 v1, s14, v1
	v_lshlrev_b32 v1, 1, v1
	v_add_i32 v0, vcc, v0, v1
	v_lshlrev_b32 v1, 2, v0
	v_add_i32 v1, vcc, s13, v1
	tbuffer_load_format_x v2, v1, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_add_i32 v0, vcc, s14, v0
	v_lshlrev_b32 v0, 2, v0
	v_add_i32 v0, vcc, s13, v0
	tbuffer_load_format_x v3, v0, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0)
	v_add_f32 v4, v3, v2
	tbuffer_store_format_x v4, v1, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// Merged FastWalshTransform_Kernels_ilp.s FastWalshTransform_Kernels_misource.s
