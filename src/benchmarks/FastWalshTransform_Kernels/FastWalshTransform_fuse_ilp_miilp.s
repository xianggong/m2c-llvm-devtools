...
// SKBB#0:                                 // %entry
	...
	v_subrev_i32 v3, vcc, s8, v0
	v_cndmask_b32 v3, v3, v0, s[2:3]
	v_add_i32 v1, vcc, -1, v1
	v_cndmask_b32 v1, v2, v1, s[0:1]
	v_mul_lo_i32 v1, s8, v1
	v_lshlrev_b32 v1, 1, v1
	v_add_i32 v0, vcc, s8, v0
	v_cndmask_b32 v0, v3, v0, s[0:1]
	v_add_i32 v0, vcc, v0, v1
...
// Merged FastWalshTransform_Kernels_ilp.s FastWalshTransform_Kernels_miilp.s
