...
// SKBB#0:                                 // %entry
	...
	v_mul_lo_i32 v1, s8, v1
	v_add_i32 v3, vcc, s8, v0
	v_cndmask_b32 v0, v2, v0, s[2:3]
	v_cndmask_b32 v0, v0, v3, s[0:1]
	v_lshlrev_b32 v1, 1, v1
	v_add_i32 v0, vcc, v0, v1
	v_add_i32 v1, vcc, s8, v0
	v_lshlrev_b32 v0, 2, v0
	...
	v_add_i32 v1, vcc, s13, v1
	tbuffer_load_format_x v3, v1, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0)
	v_add_f32 v4, v3, v2
	v_subrev_f32 v2, v3, v2
	tbuffer_store_format_x v4, v0, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// Merged FastWalshTransform_Kernels_ilp.s FastWalshTransform_Kernels_source.s
