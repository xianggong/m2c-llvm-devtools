...
// Merged ScanLargeArrays_Kernels_fast.s ScanLargeArrays_Kernels_ilp.s
...
// BB#3:                                 // %for.cond.cleanup
	...
	v_mov_b32 v0, s2
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v5, v0, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// BB#9:                                 // %if.then.38
	...
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v0, v2, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0) & expcnt(0)
BB1_11:                                 // %if.end.56
	s_or_b64 exec, exec, s[2:3]
	s_endpgm
