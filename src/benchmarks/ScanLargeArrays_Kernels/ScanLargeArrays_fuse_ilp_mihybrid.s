...
// SKBB#1:                                 // %if.then
	...
	s_add_i32 s3, s1, s3
	v_mov_b32 v1, s3
	tbuffer_load_format_x v1, v1, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_mov_b32 m0, -1
	v_mov_b32 v2, 0
	s_waitcnt vmcnt(0)
	ds_write_b32 v2, v1
...
// Merged ScanLargeArrays_Kernels_ilp.s ScanLargeArrays_Kernels_mihybrid.s
...
// SKBB#6:                                 // %if.then
	...
	v_subrev_i32 v8, vcc, v7, v5
	v_lshlrev_b32 v8, 2, v8
	v_subrev_i32 v9, vcc, v7, v4
	v_lshlrev_b32 v9, 2, v9
	s_mov_b32 m0, -1
