...
// Merged ScanLargeArrays_Kernels_ilp.s ScanLargeArrays_Kernels_miilp.s
...
// SKBB#10:                                // %if.else
	...
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v0, v4, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0) & expcnt(0)
	ds_read_b32 v0, v3
