...
BB0_2:                                  // %if.end
	...
	tbuffer_load_format_x v1, v0, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_mov_b32 v2, 0
	s_mov_b32 m0, -1
	ds_read_b32 v2, v2
...
// Merged ScanLargeArrays_Kernels_ilp.s ScanLargeArrays_Kernels_mifast.s
...
// BB#6:                                 // %if.then
	...
	ds_read_b32 v9, v9
	v_subrev_i32 v10, vcc, v7, v4
	v_lshlrev_b32 v10, 2, v10
	v_add_i32 v10, vcc, s0, v10
	ds_read_b32 v11, v3
	ds_read_b32 v10, v10
	s_waitcnt lgkmcnt(0)
	v_add_f32 v9, v8, v9
	v_add_f32 v8, v11, v10
BB1_7:                                  // %if.end
                                        //   in Loop: Header=BB1_5 Depth=1
...
// BB#3:                                 // %for.cond.cleanup
	...
	v_mov_b32 v6, s2
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v5, v6, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// BB#10:                                // %if.else
	...
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v0, v5, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0) & expcnt(0)
	v_lshlrev_b32 v0, 2, v1
	v_add_i32 v0, vcc, s1, v0
	tbuffer_store_format_x v4, v0, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	s_waitcnt vmcnt(0) & expcnt(0)
BB1_8:                                  // %Flow
...
// BB#9:                                 // %if.then.38
	...
	v_mov_b32 v3, 0
	tbuffer_store_format_x v3, v2, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// SKBB#0:                                 // %entry
	...
	v_lshlrev_b32 v4, 1, v0
	v_lshlrev_b32 v7, 3, v0
	v_or_b32 v5, 1, v4
	v_lshlrev_b32 v8, 2, v5
	v_lshlrev_b32 v3, 1, v1
	v_or_b32 v2, 1, v3
	v_lshlrev_b32 v1, 2, v2
	v_add_i32 v1, vcc, s15, v1
	tbuffer_load_format_x v9, v1, s[20:23], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_add_i32 v1, vcc, s1, v7
	s_waitcnt vmcnt(1)
	ds_write_b32 v1, v6
	s_waitcnt lgkmcnt(0)
	v_add_i32 v6, vcc, s1, v8
	s_waitcnt vmcnt(0)
	ds_write_b32 v6, v9
...
// SKBB#9:                                 // %if.then.38
	...
	v_add_i32 v0, vcc, s0, v0
	v_mov_b32 v3, 0
	tbuffer_store_format_x v3, v0, s[8:11], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_lshlrev_b32 v0, 2, v2
	v_add_i32 v0, vcc, s0, v0
	s_mov_b32 m0, -1
	ds_read_b32 v1, v1
...
// BB#9:                                 // %if.then.35
	...
	v_add_i32 v1, vcc, s1, v1
	v_mov_b32 v3, 0
	tbuffer_store_format_x v3, v1, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_lshlrev_b32 v1, 2, v2
	v_add_i32 v1, vcc, s1, v1
	s_waitcnt lgkmcnt(0)
	tbuffer_store_format_x v0, v1, s[4:7], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
...
// SKBB#0:                                 // %entry
	...
	tbuffer_load_format_x v9, v1, s[16:19], 0x0  offen format:[BUF_DATA_FORMAT_32,BUF_NUM_FORMAT_FLOAT]
	v_add_i32 v1, vcc, s1, v7
	s_waitcnt vmcnt(1)
	ds_write_b32 v1, v6
	s_waitcnt lgkmcnt(0)
